<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="WebApplicationAPIMap_XAGFR.WebForm1" %>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <!-- Ahora agregamos un boton para cerra el modal -->
                                <div class="col-sm-1">
                            ...
                            <script>
                                $('#ModalMapPreview').locationpicker({
                                    radius: 0,
                                    location: {
                                        latitude: 27.367943111889126,
                                        longitude: -109.932667215332
                                    },
